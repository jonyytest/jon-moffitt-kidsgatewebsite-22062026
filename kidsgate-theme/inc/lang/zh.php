...
return array(
	...
	'meta' => array(
		'description' => 'The Kids Gate 是一个面向 5–12 岁儿童的 AI 智能学习平台：通过游戏、故事和测验，对标剑桥英语和国际数学课程。14 天免费试用，无需信用卡。',
	),
	...
	'home' => array(
		'hero' => array(
			...
			'lede'     => 'AI 智能、对标剑桥英语和国际数学课程，专为 5&ndash;12 岁儿童设计，包含游戏、故事和测验，每答一题都会自动调整。',
			'badge_lessons'  => '1,800+',
	...
	'features' => array(
		...
		'grid' => array(
			...
			'lede'   => '',
			'items'  => array(
				array( 'title' => '对标剑桥英语', 'text' => '从自然拼读到语法，对齐 5–12 岁的剑桥英语阶段。' ),
	...
	'parents' => array(
		...
		'faq' => array(
			...
			'items'  => array(
				...
				array(
					'q' => '它真的能匹配孩子的学校课业吗？',
					'a' => 'The Kids Gate 对标 1–6 年级的剑桥英语和国际数学课程。自适应路径意味着它通过填补缺口和拓展优势来补充学校教育，而不是重复家庭作业。',
				),
				array(
					'q' => '如果孩子觉得太简单或太难怎么办？',
	...
	'schools' => array(
		...
		'align' => array(
			...
			'lede'   => '',
			'items'  => array(
				array( 'title' => '对标剑桥英语', 'text' => '阶段对齐的英语内容，从自然拼读到自信的读写。' ),
	...
	'support' => array(
		...
		'faq_items' => array(
			array(
				...
				'pop' => true,
				'q'   => 'The Kids Gate 是什么？',
				'a'   => 'The Kids Gate 是一个面向 5–12 岁儿童的 AI 智能学习平台。它通过游戏、故事、测验、歌曲、谜题和其他互动活动，为 1–6 年级提供对标剑桥英语和国际数学的课程。',
			),
			array(
				'cat' => 'plans',
				'pop' => true,
			...
			array(
				...
				'a'   => '三点：课程在每次作答后即时调整（每两周还会重新评估水平）；内容对标真正的剑桥英语和国际数学课程体系；奖励表彰努力，而不只是答对。这一切都在完全无广告的环境中进行。',
				'kw'  => '不同 区别 比较 更好 对比',
			),
			array(
				'cat' => 'product',
			...
			array(
				...
				'a'   => '可以。课程自定进度，对标剑桥英语和国际数学的 1–6 年级内容，家长仪表盘按主题显示掌握程度，家庭教育者能清楚看到已学内容和需要关注的地方。',
				...
				array(
					...
					'children' => array(
						...
						array(
							'id'     => 'using-subjects',
							'label'  => '科目与年级',
							'answer' => '孩子可以学习对标剑桥英语、国际数学，或两者，覆盖 1–6 年级（5–12 岁）。',
						),
						array(
							'id'     => 'using-safe',
							'label'  => '它安全且无广告吗？',
